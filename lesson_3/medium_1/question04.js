...
//MY SOLUTION: There is no difference. 

//THE SOLUTION: 
//Yes, there is a difference. While both methods have the same return value,
//the first implementation mutates the buffer argument. That is, the caller
//will see that the array is different when the function returns. The 
//rollingBuffer2 implementation doesn't mutate the buffer argument.