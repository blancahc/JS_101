...
// The code arr[0] += 2 modifies the array arr, but not a. In effect,
// we are assigning a new object to that index of the array so that instead
// of arr[0] containing 2, the value obtained from a, it now contains 4. We
